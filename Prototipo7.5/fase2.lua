...
function scene:create( event )
	...
	local bg1 = display.newImageRect (backGroup, "imagens/bg.jpg", 1999*0.25, 2000*0.25)
	bg1.x = 160
	bg1.y = 240
	bg1.xScale = 1.202
	bg1.yScale = 1.200
	...
	local bg2 = display.newImageRect (backGroup, "imagens/bg.jpg", 1999*0.25, 2000*0.25)
	bg2.x, bg2.y = 544, 240
	bg2.xScale = 1.202
	bg2.yScale = 1.200
