...
function scene:create( event )
    ...
    -- local bg1 = display.newImageRect(backGroup, "imagens/sea.png", display.actualContentWidth, display.actualContentHeight)
    -- bg1.x = display.contentCenterX
    -- bg1.y = display.contentCenterY
    -- bg1.xScale = 1.700
	-- bg1.yScale = 1.200

	local bg1 = display.newImageRect (backGroup, "imagens/sea.png", 740, 523)
    bg1.y = 240
	transition.to (bg1, {time=100000, x=0, iterations=0})

	local bg2 = display.newImageRect (backGroup, "imagens/sea.png", 740, 523)
    bg2.y = 240
	transition.to (bg2, {time=100000, x=370, iterations=0})
